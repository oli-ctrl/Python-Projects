...
## snake start params (maybe change speed depending on pc speed, 0.5 is good for me, on a slower machine it was good at 0.2)
score = 0
speed = 0.5
direction = "Right"
lenght = 2
...
class Snake:
    ...
    def checkValid(self):
        ...
        if int(self.nextpos[0]) >= x or int(self.nextpos[1]) >= y or int(self.nextpos[0]) < 0 or int(self.nextpos[1]) < 0:
            print("hit wall")
            return False
